...
export async function generateMetadata() {
  return generateSEOMetadata({
    ...
    description: '📖 Descarga el libro keto más completo de España. +200 recetas probadas, plan de 30 días, calculadora de macros. Transforma tu cuerpo en 30 días. Garantía incluida. Solo €29.99',
